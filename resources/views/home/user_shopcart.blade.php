...
@section ('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h1 style="font-size: 30px; text-align: center;padding-top: 30px;">SEPETİM</h1>
                <table id="customers">
                    <tr>
                        <th colspan="2">Kitap</th>
        ...
        <div class="row">
            <div class="col-sm-6" style="padding-left: 20px;">
                <br><br>
                <h1 style="font-size: 30px; padding-left: 200px;"><a href="{{route('allproductlist')}}">BUNLARA DA GÖZAT!</a></h1>
            </div>
