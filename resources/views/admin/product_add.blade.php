                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form role="form" action="{{route('admin_product_store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Stok</label>
                                        <input type="number" name="quantity" value="5" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="basimyili" value="2000" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Sayfa Sayısı</label>
                                        <input type="number" name="sayfasayisi" value="100" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Dil</label>
                                        <input type="text" name="dil" value="Türkçe" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Yazar</label>
